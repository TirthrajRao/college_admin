angular.module('account')
  .controller('accountSearchReceiptCtrl',['$scope','$state','$rootScope','accountFactory',function($scope,$state,$rootScope,accountFactory){
    ...
    $scope.searchReceipt = function(id){
      accountFactory.getReceiptByCourse($scope.courseid,id)
      .then(function(response){
